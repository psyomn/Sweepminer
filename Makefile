...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Thu Apr 28 02:06:24 2011
...
obj/GameStats.o: GameStats.cxx GameStats.hxx
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/GameStats.o GameStats.cxx

obj/TinyColor.o: tinyc/TinyColor.cxx tinyc/TinyColor.hxx
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/TinyColor.o tinyc/TinyColor.cxx
